...
import { ProductCategory, Product, Recipe } from '../../../types';
...
interface EditProps {
    product: Product & { recipes?: Recipe[] };
    categories: ProductCategory[];
    ingredients: Ingredient[];
}

export default function Edit({ product, categories, ingredients }: EditProps) {
    ...
    return (
        <AdminLayout title="Edit Produk">
            <Head title={`Edit Produk - ${product.name} - EWWON COCO`} />
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <div className="bg-white p-8 rounded-[40px] border border-[#F0F0F0] shadow-sm space-y-6 sticky top-8">
                            ...
                            >
                                ...
                                <span className="uppercase tracking-[0.2em] text-[13px]">Perbarui Menu</span>
                            </button>
                        </div>
                    </div>
                </form>
